...
"""Defines unittests for models/rectangle.py. Done by Joe Mwangi
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for testing _str_ and display methods of Rectangle class."""
    ...
    def test_str_method_width_height_x(self):
        ...
        self.assertEqual(correct, r._str_())
